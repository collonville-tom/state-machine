...
public class SystemExecMouse implements CommandListener {
	...
	private ImageItem systemView = new ImageItem("", Image.createImage(system.getClass().getResourceAsStream("")), ImageItem.PLAIN, null);

	private SystemChoice system;

	public SystemExecMouse(SystemChoice system) {
		this.system = system;
