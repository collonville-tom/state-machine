 ...
 * 
 * <p>
 * This interface is a member of the <a href="{@docRoot}/../guide/collections/index.html">
...
public interface Collection {
	 ...
	 *             if the specified collection contains one or more null
	 *             elements and this collection does not support null elements,
	 *             or if the specified collection is <tt>null</tt>.
	 * @throws IllegalArgumentException
	 ...
	 * the default "reference comparison." (The <tt>List</tt> and <tt>Set</tt>
	 ...
	 * collection is compared to any list or set. (By the same logic, it is not
	 * possible to write a class that correctly implements both the <tt>Set</tt>
	 * and <tt>List</tt> interfaces.)
	 * 
	 * @param o
